...
$array_list = [
    [
        'name' => '2012 Rossignol District Snowboard',
...
function okrugl($number){
    $number_okr = ceil($number);
    if ($number_okr > 1000){
        $number_okr = number_format($number_okr);
    }
    return $number_okr;
}
...
<main class="container">
    ...
    <section class="lots">
        ...
        <ul class="lots__list">
            <?php foreach ($array_list as $key => $val): ?>
                    ...
                    <div class="lot__info">
                        ...
                        <div class="lot__state">
                            <div class="lot__rate">
                                ...
                                <span class="lot__cost"><?=okrugl($val['price']);?><b class="rub">р</b></span>
                            </div>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            <?php $index = 0; $num_count = count($array); ?>
            <?php while ($index < $num_count): ?>
                <li class="nav__item">
                    <a href="/?cat=<?=$index;?>"><?=$array[$index];?></a>
                </li>
                <?php $index++; ?>
            <?php endwhile;?>
        </ul>
